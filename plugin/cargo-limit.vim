...
fun! s:maybe_setup_handlers() abort
  ...
  if exists('*CargoLimitOpen')
    ...
    call s:log_warn('g:CargoLimitOpen is deprecated, please migrate to g:CargoLimitUpdate (requires cargo-limit >=0.0.11): https://github.com/cargo-limit/cargo-limit#text-editoride-integrations')
  endif
